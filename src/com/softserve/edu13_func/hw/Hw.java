...
public class Hw {
    ...
    public static void task1() {
        String originalText = "Java is the best programmer language";
        int offset = 10;
    ...
    public static void task4() {
        LocalDate birthday = LocalDate.of(1998, Month.NOVEMBER, 11);

        printDayOfWeek(birthday);
        printDayOfWeek(birthday.plusMonths(3));
        printDayOfWeek(birthday.plusMonths(10));
    }
